...
export const NewsLetter = () => {
  ...
  const urlMail = `${process.env.NEXT_PUBLIC_API_URL}/api/v1/newsletter`;
  const logoNewsLetter = `${process.env.NEXT_PUBLIC_API_URL}/images/logo-newsletter.webp`;
  const messages = {
    default:
      "Recibe en tu correo las noticias más destacadas para viajar, trabajar y vivir en EU",
    success:
      "Gracias por registrarte, te enviamos un correo para confirmar tu dirección.",
  };
  ...
  const handleSendSubscription = () => {
    axios.post(urlMail, subscriptor).then(() => {
  ...
  return (
    <div className="text-[white] font-['Work_Sans'] m-[10px] p-5 bg-[length:100%_100%] bg-[url('https://www.viveusa.mx/sites/all/modules/widget_newsletter/css/back-widget.webp')]">
      ...
      <p className="my-3 text-[17px]">{message}</p>
      <form
      ...
      >
        ...
        <span className="text-[11px] text-grey-0 mt-2">
